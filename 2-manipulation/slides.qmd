...
The fist step in exploring a dataset is to understand its structure and size.
...
Select specific rows based on conditions is a common task in data manipulation.
